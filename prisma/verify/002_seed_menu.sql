-- ============================================================================
-- Hat Gao menu — seed data
-- ============================================================================
-- Transcribed from "hat gao menu store 3.pdf" (the current printed menu).
--
-- Conventions:
--   * All money in integer cents. €8.50 → 850.
--   * VAT in basis points: 500 = 5% (food), 900 = 9% (soft drinks/juices),
--     1900 = 19% (beer — alcohol is standard-rated).
--   * IDs are human-readable here rather than UUIDs, so this seed data can
--     be read and debugged by eye. Production rows use UUIDs.
--   * allergensVerified is FALSE on every row. Allergen data is drafted
--     separately and does not publish until a human confirms it.
--
-- Known typos in the printed menu, corrected here (flagged to Tan):
--   "Peaking Duck" → "Peking Duck"
--   "mined pork"   → "minced pork"
--   "vermicellli"  → "vermicelli"
--   Tofu items 50/51 priced "$8" → "€8"
-- ============================================================================
